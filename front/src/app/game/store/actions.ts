...
import { character, resultCharacter, formEnum } from 'src/app/types/gameTypes';
...
export const submitCharSuccess = createAction('[game] submit char success', props<{data: {character: resultCharacter, score: number}}> ());